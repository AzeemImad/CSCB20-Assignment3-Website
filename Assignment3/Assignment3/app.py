...
#most code gotten from https://flask.palletsprojects.com/en/1.1.x/patterns/sqlite3/
...
#inspiration for said code is gathered from : https://pythonspot.com/login-authentication-with-flask/
@app.route('/')
def home():
...
# inspiration for said code is gathered from : https://stackoverflow.com/questions/15702255/storing-radio-button-value-in-sqlite-database
# inspiration for said code is gathered from : https://stackoverflow.com/questions/40205518/flask-sqlite-python-checking-if-username-is-already-in-database
